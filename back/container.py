...
class Container(containers.DeclarativeContainer):
    ...
    db = providers.Singleton(
        ...
        connection_pool_min_size=providers.Callable(
            lambda e: e.db_connection_pool_min_size, envs
        ),
        connection_pool_max_size=providers.Callable(
            lambda e: e.db_connection_pool_max_size, envs
        ),
    )
